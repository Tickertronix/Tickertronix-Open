...
**CRITICAL**: You must configure TFT_eSPI for the ESP32-2432S028R display.
...
2. **Edit `User_Setup_Select.h`**:
   ...
   // Uncomment the ESP32-2432S028R setup:
   #include <User_Setups/Setup25_TTGO_T_Display.h>  // Or create custom
   ```

3. **OR Create Custom `User_Setup.h`** (Recommended):
   ```cpp
